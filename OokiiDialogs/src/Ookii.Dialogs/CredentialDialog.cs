...
namespace Ookii.Dialogs
{
    ...
    public partial class CredentialDialog : Component
    {
        ...
        public DialogResult ShowDialog(IWin32Window owner)
        {
			...
			//In particular, if ShowUIForSavedCredentials is true, on Vista the password box will not be 
			//populated with the stored password. This is a bug in the Vista version of the credential dialog, 
			//it's not a bug with my code, and I have no way to work around it.

			//This limits the new-style dialog to Windows 7, and causes Vista to use the old-style dialog, 
			//which does behave correctly in all circumstances.
