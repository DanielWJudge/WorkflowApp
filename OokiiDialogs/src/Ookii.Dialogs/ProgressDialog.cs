...
namespace Ookii.Dialogs
{
	...
	public partial class ProgressDialog : Component
	{
		...
		private Timer _tmrCancellationCheck;
		...
		public bool CancellationPending
		{
			...
			protected set { _cancellationPending = value; }
		}
		...
		private void RunProgressDialog(IntPtr owner, object argument)
		{
			...
			_dialog = (Interop.IProgressDialog)new Interop.ProgressDialogRCW();
			...
			_tmrCancellationCheck = new Timer();
			_tmrCancellationCheck.Interval = 250;
			_tmrCancellationCheck.Tick += (o, e) =>
			{
				Cancellation_TimerTick();
			};
			_tmrCancellationCheck.Start();

			_backgroundWorker.RunWorkerAsync(argument);
		}

		private void Cancellation_TimerTick()
		{
			if (_cancellationPending) _tmrCancellationCheck.Stop();
			lock (this)
				if (_dialog != null)
		...
		private void _backgroundWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
		{
			...
			{
				Cancellation_TimerTick();
				if (_tmrCancellationCheck != null)
					_tmrCancellationCheck.Dispose();
		...
		private void _backgroundWorker_ProgressChanged(object sender, ProgressChangedEventArgs e)
		{
			lock (this)
			{
				...
				if (e != null && e.ProgressPercentage >= 0 && e.ProgressPercentage <= 100)
				{
					try
					{
