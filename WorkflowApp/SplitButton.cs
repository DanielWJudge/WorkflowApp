...
namespace WorkflowApp
{
    public class SplitButton : Button
    {
        ...
        /// <summary>
        /// Ocurrs when a control is clicked.
        /// </summary>
        ...
        int _registeredClickEvents = 0;

        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool HasClickEvent { get { return _registeredClickEvents > 0; } }
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            if (!isSplitMenuVisible && e.Button == MouseButtons.Left && (!HasClickEvent || dropDownRectangle.Contains(e.Location)))
            {
                ShowContextMenuStrip();
            }
            else
